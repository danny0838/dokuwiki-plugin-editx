...
$lang['rp_nr']              = 'Do not leave redirect message on the old page';
...
$lang['rp_msg_new_exist']   = 'The new page <a href="%s">%s</a> already exists.';
...
$lang['rp_msg_file_conflict'] = 'A conflict occurred on new page file %s. <a href="%s">Review the older revisions</a> or use the <a href="%s">Page management</a> plugin to remove all references to the new page.';
$lang['rp_msg_success']     = 'Page %s successfully renamed to %s.';

// delete page = dp
$lang['dp_title']           = 'Page Deletion';
$lang['dp_purge']           = 'Do not leave a delete notice';
